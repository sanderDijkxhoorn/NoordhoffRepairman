function addButton() {
  ...
  setTimeout(function () {
    ...
    document
      .querySelector("#scroll-view > div > div > div > section > div")
      .appendChild(npSA);
  }, 2000);
